                ...
                <div class="col-lg">
                    ...
                    <table class="table table-bordered table-hover" id="browseiku">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="text-center nomorikubawahan" scope="row"><?= $i; ?></th>
                                <td class="text-center kodeikubawahan"><?= $iku['kodeiku']; ?></td>
                                <td class="namaikubawahan"><?= $iku['namaiku']; ?></td>
                                <td class="text-center nilaitertinggiikubawahan"><?= $iku['targetiku']; ?> dari <?= $iku['nilaitertinggi']; ?></td>
                                <?php if ($this->session->userdata('role_id') == 1) : ?>
                                <td class="text-center namavalidatorikubawahan"><?= $iku['nama_validated']; ?></td>
                                <?php endif; ?>
