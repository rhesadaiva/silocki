                                ...
                                <tr class="detail">
                                    ...
                                    <td class="aksi">
                                        <?php if ($logbook['is_approved'] == 0) : ?>
                                            ...
                                            <a data-toggle="tooltip" data-placement="left" title="Setuju Logbook Bawahan" class="button-approvelogbookbawahan" href="<?= base_url(); ?>pejabat/approvelogbook/<?= $logbook['id_logbook']; ?>"><span style="color:blue;"><i class="fas fa-fw fa-thumbs-up"></i></span></a>

                                        <?php else : ?>

                                            <a data-toggle="tooltip" data-placement="left" title="Batalkan Persetujuan Logbook" class="button-batalapprovelogbookbawahan" href="<?= base_url(); ?>pejabat/batalapprovelogbook/<?= $logbook['id_logbook']; ?>"><span style="color:red;"><i class="fas fa-fw fa-thumbs-down"></i></span></a>
