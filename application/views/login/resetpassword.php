                ...
                <div class="col-lg-4 col-md-6 ml-auto mr-auto">
                    <div class="card card-login">
                        ...
                        <div class="card-body card-form">
                            <!-- Form -->
                            <form method="post" action="<?= base_url('auth/aksiresetpassword'); ?>">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="token_number" class="form-control" placeholder="Token Telegram" value="<?= set_value('nip'); ?>" autocomplete off>
                                </div>
