...
--
-- Host: localhost
-- Generation Time: Jun 21, 2019 at 05:11 AM
...
('5d09ad4c933ad', '199506072015021003', '4/BC.15.7.12/2019', '1a-N', 'Persentase realisasi penerimaan dan penelitian kelengkapan dokumen kepabeanan dan cukai sesuai janji layanan', '(Dokumen yang diterima dan diteliti tepat waktu / Dokumen yang diterima dan diteliti) x 100%', '92%', '100%', 'Persentase', 'Average', 1, 'Zuhalta'),
('5d09adcfa42c9', '199506072015021003', '4/BC.15.7.12/2019', '1b-N', 'Persentase penyelesaian dokumen PIB dan PEB ke Sistem Aplikasi CEISA', '(Dokumen yang diadministrasikan) / (Dokumen yang sudah terkirim ke CEISA) x 100%', '92%', '100%', 'Persentase', 'Average', 0, ''),
('5d09ae83d1e64', '199506072015021003', '4/BC.15.7.12/2019', '1c-N', 'Persentase penyelesaian permintaan modul aktivasi importir, eksportir, PPJK dan sarana pengangkut', '(Penyelesaian permintaan modul / Jumlah permintaan modul) x 100%', '92%', '100%', 'Persentase', 'Average', 0, ''),
('5d09aee0c8d00', '199506072015021003', '4/BC.15.7.12/2019', '2a-C', 'Persentase Penyelesaian permasalahan CEISA', '(Jumlah tiket permasalahan yang diselesaikan unit kerja / Jumlah tiket permasalahan yang dibuat) x 100%', '92%', '100%', 'Persentase', 'Average', 0, ''),
('5d09af9ee9c58', '199506072015021003', '4/BC.15.7.12/2019', '2b-C', 'Indeks Ketepatan Waktu Pelaksanaan Persiapan Operasional CEISA', '((Jumlah kegiatan harian yang dilakukan / Jumlah kegiatan yang seharusnya dilakukan) x 100%) / Jumlah hari kerja pada bulan bersangkutan', '3', '4', 'Indeks', 'Average', 0, '');
...
('5d09a1e77d70a', '199506072015021003', 'Pertama', '4/BC.15.7.12/2019', '2019-01-01', '2019-12-31', 2, 'Rabu, 19 Juni 2019 | Pukul 15:09 WIB', 'Zuhalta');
...
INSERT INTO `logbook` (`id_logbook`, `id_iku`, `periode`, `perhitungan`, `realisasibulan`, `realisasiterakhir`, `ket`, `wakturekam`, `is_approved`, `is_sent`, `tgl_approve`, `tgl_batalapprove`, `nama_validated`) VALUES
('5d09e0b75905b', '5d09ad4c933ad', 'Januari', '(27 / 27) x 100% = 100%', '100%', '100%', 'IKU ini dapat dipenuhi karena ada penerimaan dokumen PIB sebanyak 25 dokumen dan PPFTZ-01 Dalam negeri sebanyak 2 dokumen.', 'Rabu, 19 Juni 2019 | Pukul 14:13 WIB', 1, 1, 'Rabu, 19 Juni 2019 | Pukul 15:13 WIB', '', 'Zuhalta'),
('5d09e18310170', '5d09ad4c933ad', 'Februari', '(16 / 16) x 100% = 100%', '100%', '100%', 'IKU ini dapat dipenuhi karena ada penerimaan dokumen PIB sebanyak 15 dokumen dan PPFTZ-01 Dalam negeri sebanyak 1 dokumen.', 'Rabu, 19 Juni 2019 | Pukul 14:17 WIB', 0, 0, 'Rabu, 19 Juni 2019 | Pukul 14:30 WIB', '', '');
...
(16, 'Vicky Fadian', '198206232001121001', 'Penata Muda/III.a', 'e10adc3949ba59abbe56e057f20f883e', 4, 'Subseksi Hanggar Pabean dan Cukai II', 'Zuhalta'),
(17, 'Oriettha Deany', '199501172015122002', 'Pengatur Muda/II.a', 'e10adc3949ba59abbe56e057f20f883e', 5, 'Subseksi Hanggar Pabean dan Cukai XI', 'Vicky Fadian');
